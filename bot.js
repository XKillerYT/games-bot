...
if (message.content.startsWith(prefix + "عواصم")) {
 ...
 const cd = [
          'CD | اكثر سلاح تستعمله ؟',
          'CD | حسب رأيك هل اللعبة قلدت فورت نايت فعلاً ؟',
          'CD | حسب رأيك من افضل هي او فورت نايت ؟',
          'CD | اكثر سلاح تكرره ؟',
          'CD | هل انت مشتري شيء باللعبة ؟',
          'CD | ايش هو اكثر طور تحبه ؟',
          'CD | كم مرة فزت ؟',
          'CD | ايش هو اعلى عدد قتلات جبته ؟',
          'CD | كم سكن عندك ؟',
...
.setTitle("** لعبة اسئلة كريتف دستروكشن **")
.setColor("RANDOM")
.setDescription(`${cd[Math.floor(Math.random() * cd.length)]}`)
.setThumbnail('https://pbs.twimg.com/profile_images/1008033991960608768/3iOy5Py9_400x400.jpg')
             .setTimestamp()
